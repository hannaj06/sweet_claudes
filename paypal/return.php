...
<?php 
	...
	*/
	...
	db_connect();
	$sql = 'INSERT INTO Orders (order_date, customer_id) VALUES(CURDATE(),'. $_SESSION['customer_id'].');';
	...
	foreach($_SESSION['cart'] as $i){
		$sql = 'INSERT INTO Order_item (order_id, product_id, quantity) VALUES('.$row['ID'].','. $i['id'].','. $i['quantity'].');';
		mysqli_query($db, $sql);
	}
		...
		?>
    		...
    		<span class="span5">
    			...
    			<h3> <?php echo($firstName); ?>
    				<?php echo($lastName); ?> , Thank you for your Order </h3>
